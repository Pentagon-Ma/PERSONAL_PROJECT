...
async function experimentInit() {
  ...
  Informed_Q3 = new visual.TextBox({
    win: psychoJS.window,
    name: 'Informed_Q3',
    text: 'I consent to the use of my email address to obtain a gift card, \nif I so choose\n\n(Press Y if you agree, ESC to quit the experiment)',
    font: 'Open Sans',
    pos: [0, 0], letterHeight: 0.03,
    size: [1, 0.5],  units: undefined, 
    color: 'white', colorSpace: 'rgb',
  ...
  C_1 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.65), 0.1], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('white'),  opacity: undefined,
    depth: -6.0 
  });
  ...
  C_2 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.7), 0.1], height: 0.03,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('white'),  opacity: undefined,
    depth: -6.0 
  });
...
function Informed_Consent_1RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Consent_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Consent_3RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_consent_4RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_consent_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Consent_5RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Consent_6RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Consent_7RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Consent_7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_consent_8RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_consent_8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Question_1RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Question_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Question_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Question_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Informed_Question_3RoutineBegin(snapshot) {
  return async function () {
    ...
    Informed_Question_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Comp_recall_branchLoopBegin(Comp_recall_branchLoopScheduler, snapshot) {
  return async function() {
    ...
    Comp_recall_branch.forEach(function() {
...
function Comp_Do_BranchLoopBegin(Comp_Do_BranchLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    Comp_Do_Branch.forEach(function() {
...
function Comprehension_RecallRoutineBegin(snapshot) {
  return async function () {
    ...
    Comprehension_RecallComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Comprehension_DoRoutineBegin(snapshot) {
  return async function () {
    ...
    Comprehension_DoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Book_RecallRoutineBegin(snapshot) {
  return async function () {
    ...
    Book_RecallComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Book_RecallRoutineEachFrame() {
  return async function () {
    ...
    if (Clock_6.status === PsychoJS.Status.STARTED){ // only update if being drawn
      Clock_6.setText(('%d' % timer.getTime()), false);
    }
...
function Book_DoRoutineBegin(snapshot) {
  return async function () {
    ...
    Book_DoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Book_DoRoutineEachFrame() {
  return async function () {
    ...
    if (Clock_1.status === PsychoJS.Status.STARTED){ // only update if being drawn
      Clock_1.setText(('%d' % timer.getTime()), false);
    }
...
function Questionnaire_phase_introductionRoutineBegin(snapshot) {
  return async function () {
    ...
    Questionnaire_phase_introductionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q6RoutineBegin(snapshot) {
  return async function () {
    ...
    Q6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q10RoutineBegin(snapshot) {
  return async function () {
    ...
    Q10Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q11RoutineBegin(snapshot) {
  return async function () {
    ...
    Q11Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q12RoutineBegin(snapshot) {
  return async function () {
    ...
    Q12Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q13RoutineBegin(snapshot) {
  return async function () {
    ...
    Q13Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q14RoutineBegin(snapshot) {
  return async function () {
    ...
    Q14Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q15RoutineBegin(snapshot) {
  return async function () {
    ...
    Q15Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Q16RoutineBegin(snapshot) {
  return async function () {
    ...
    Q16Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q1RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q2RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q3RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q4RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q5RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q6RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q7RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q8RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q10RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q10Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q11RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q11Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Demo_Q12RoutineBegin(snapshot) {
  return async function () {
    ...
    Demo_Q12Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
